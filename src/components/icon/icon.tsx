...
export class Icon {
  ...
  loadIcon() {
    if (Build.isBrowser && this.isVisible) {
      ...
      if (url) {
        if (medirexiconContent.has(url)) {
          // sync if it's already loaded
          this.svgContent = medirexiconContent.get(url);
        } else {
          // async if it hasn't been loaded
          getSvgContent(url, this.sanitize).then(() => (this.svgContent = medirexiconContent.get(url)));
        }
